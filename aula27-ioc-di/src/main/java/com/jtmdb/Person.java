...
/**
 * This is the class that represents a Person. It also provides static methods for searching for a person and for getting a specific person. Has two "flavors". The normal one and a reduced one. The reduced is returned when searching for people and is missing some fields that are present when getting the info for a specific person.
...
public class Person implements Serializable {
	...
	/**
	 * The birthplace of the person. Not present in reduced form (see class description  {@link Person}  and method  {@link #isReduced()} ).
	...
	/**
	 * The number of known movies of the person. Not present in reduced form (see class description  {@link Person}  and method  {@link #isReduced()} ).
	 ...
	 * @param knownMovies  The number of known movies of the person.
	 * @uml.property  name="knownMovies"
	 */
	...
	/**
	 * The filmography of the person. Not present in reduced form (see class description  {@link Person}  and method  {@link #isReduced()} ).
	 ...
	 * @param filmography  The filmography of the person.
	 * @uml.property  name="filmography"
	 */
	 ...
	 * @param popularity  The popularity of the person.
	 * @uml.property  name="popularity"
	 */
	...
	/**
	 * The birthday of the person. Not present in reduced form (see class description  {@link Person}  and method  {@link #isReduced()} ).
	...
	/**
	 * The aliases of the person. Not present in reduced form (see class description  {@link Person}  and method  {@link #isReduced()} ).
	 ...
	 * @param aka  The aliases of the person.
	 * @uml.property  name="aka"
	 */
	...
	/**
	 * Sets whether the Person contains reduced information (see class description  {@link Person} ).
	 * @param isReduced  True if the Person has reduced fields set.
	 * @uml.property  name="isReduced"
	 */
	...
	/**
	 * If true, the Person object has reduced fields set (see class description {@link Person} ).
