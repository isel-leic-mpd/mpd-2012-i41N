...
public class ViewResultsInBillboard implements IMovieQueryResult{
	...
	private final IListModelCollection<IMovie> model;

	public ViewResultsInBillboard(IListModelCollection<IMovie> model){
		this(model, Color.WHITE, Color.black);
	}

	public ViewResultsInBillboard(IListModelCollection<IMovie> model, Color back, Color fg){
