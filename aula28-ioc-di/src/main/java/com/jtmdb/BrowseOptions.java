...
public class BrowseOptions implements Serializable {
	 ...
	 * @param orderBy  The type of the ordering of the results.
	 * @uml.property  name="orderBy"
	 */
	 ...
	 * @return  The current page of the results. Will be null if the page is not  set or has been cleared.
	 * @uml.property  name="page"
	 */
	 ...
	 * @return  The amount of results displayed in each page of the results. Will  be null if the per page is not set or has been cleared.
	 * @uml.property  name="perPage"
	 */
	 ...
	 * @return  The query for the search. Will be null if it has not been set or  has been cleared.
	 * @uml.property  name="query"
	 */
	...
	/**
	 * Sets the query for the search. If you pass null it acts like {@link #clearQuery()} .
	 * @param query  The query for the search. If you pass null it acts like {@link #clearQuery()}  .
	 * @uml.property  name="query"
	 */
	 ...
	 * @param genreSelector  The genre selector for the search.
	 * @uml.property  name="genreSelector"
	 */
	 ...
	 * @return  The minimum release date a movie must have to appear in the  results.
	 * @uml.property  name="releaseMin"
	 */
	 ...
	 * @return  The maximum release date a movie must have to appear in the  results.
	 * @uml.property  name="releaseMax"
	 */
	...
	/**
	 * Sets the minimum release date a movie must have to appear in the results. If the maximum release date has not been set or if it has been set but is earlier than this date, this will set it to the latest date that can be represented. If null is passed, it acts like calling {@link #clearReleases()} . If not, this method calls  {@link #clearYear()} since they cannot be used side by side.
	 * @param ratingMin  The minimum release date a movie must have to appear in the  results. If the maximum release date has not been set or if it  has been set but is earlier than this date, this will set it  to the latest date that can be represented. If null is passed,  it acts like calling  {@link #clearReleases()}  . If not, this  method calls  {@link #clearYear()}  since they cannot be used  side by side.
	 * @uml.property  name="releaseMin"
	 */
	...
	/**
	 * Sets the maximum release date a movie must have to appear in the results. If the minimum release date has not been set or if it has been set but is later than this date, this will set it to the earliest date available (epoch). If null is passed, it acts like calling  {@link #clearReleases()} . If not, this method calls  {@link #clearYear()}  since they cannot be used side by side.
	 * @param ratingMin  The maximum release date a movie must have to appear in the  results. If the minimum release date has not been set or if it  has been set but is later than this date, this will set it to  the earliest date available (epoch). If null is passed, it  acts like calling  {@link #clearReleases()}  . If not, this  method calls  {@link #clearYear()}  since they cannot be used  side by side.
	 * @uml.property  name="releaseMax"
	 */
	 ...
	 * @return  The minimum amount of votes a Movie must have to appear in the  results.
	 * @uml.property  name="minVotes"
	 */
